...
presentation::PresentationScene RtsPresentationExtractor::extract(
...
presentation::SceneEntityKind RtsPresentationExtractor::mapKind(
...
void RtsPresentationExtractor::copyVisibility(
    const gameplay::WorldSnapshot& snapshot,
    std::uint32_t teamId,
...
bool RtsPresentationExtractor::isVisible(
